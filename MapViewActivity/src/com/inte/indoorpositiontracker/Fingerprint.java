...
public class Fingerprint {
	...
	public Fingerprint getClosestMatch(ArrayList<Fingerprint> fingerprints) {
		...
		// Log.d("time", "\n\n\n\n\n\ncalculation location took " + time + "
		// milliseconds.");
		return closest;
	}
	...
	public String toString() {
		return "Fingerprint [mId=" + mId + ", mMap=" + mMap + ", mLocation=" + mLocation + ", orientation="
				+ Arrays.toString(orientation) + ", mMeasurements=" + mMeasurements.toString() + "]\n";
	}
