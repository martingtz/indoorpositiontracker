...
public class MapActivity extends Activity implements OnTouchListener {
    ...
    private static final int MENU_ITEM_FCQI = 7;
    private static final int MENU_ITEM_PLAMEX1 = 8;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.setMap(R.drawable.plamex1); // set map to default location (== first floor)
    }
    ...
    public void onStart() {
        ...
        mReceiver = new BroadcastReceiver ()
        {
            ...
            {
            	//Toast.makeText(MapActivity.this, "Se realizo un escaneo!!", Toast.LENGTH_SHORT).show();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
    	...
    	sub.add(Menu.NONE, MENU_ITEM_FCQI, Menu.NONE, "FCQI");
    	sub.add(Menu.NONE, MENU_ITEM_PLAMEX1, Menu.NONE, "Plamex");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
	        case MENU_ITEM_PLAMEX1:
	    		setMap(R.drawable.plamex1);	
                return true;
	        case MENU_ITEM_FCQI:
        		setMap(R.drawable.fcqi);
        		return true;
